        ...
        <div className="grid-container padding-0 maxw-desktop-lg">
          <div className="padding-y-5 desktop:padding-y-7 padding-x-205">
            ...
            <div className="mx-auto desktop:padding-x-8 desktop:width-tablet-lg lg:text-center lg:font-semibold lg:text-base text-base-darkest font-public-sans-xs">
              Public health agencies have a variety of opportunities to
              contribute to the development of Building Blocks. Below we&apos;ve
              outlined how jurisdictions can get involved at various levels of
              partnership, including our beta program, focus groups, and
            ...
            <div className="desktop:grid-col-6">
              <div className="padding-x-205 padding-y-5 bg-primary-lighter desktop:radius-md desktop:padding-x-4">
                ...
                >
                  ...
                  architecture strengths and weaknesses and help improve a part
                  of their data process.
                  <br /> <br />
                  We invite you to visit our SDK toolkit where you can explore
                  the full range of modular Building Blocks. If interested in
                  getting involved in our beta program, please reach out to our
                  team.
                </div>
                <div className="text-center margin-top-2 desktop:margin-top-7 padding-x-5 desktop:padding-x-0">
                  <a href='https://www.surveymonkey.com/r/L35PNRK' target='_blank' rel="noreferrer">
            ...
            <div className="desktop:grid-col-6">
              <div className="padding-x-205 desktop:padding-x-4 padding-y-5 bg-primary-lighter radius-md">
                ...
                >
                  ...
                  <br /> <br />
                  The purpose of these focus groups is to gather STLT input on
                  how we prioritize and design potential Building Blocks. Each
