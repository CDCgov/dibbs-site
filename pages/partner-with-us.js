        ...
        <div className='desktop:padding-bottom-9 desktop:padding-top-3'>
            <div className="grid-container padding-0">
                <div className='padding-y-5 desktop:padding-y-7 padding-x-205'>
                    ...
                    <div className='mx-auto desktop:padding-x-8 desktop:width-tablet-lg lg:text-center text-base-darkest lg:font-semibold lg:text-base text-sm'>
                ...
                <div className='grid-row desktop:grid-gap-4'>
                    <div className="border-1px border-accent-cool desktop:border-0 desktop:grid-col-6">
                        <div className='padding-x-205 padding-y-5 bg-primary-lighter desktop:radius-md desktop:padding-x-4'>
                            ...
                            <h4 className={`text-center text-accent-cool-darker margin-bottom-105 ${styles.partnerItemHeaders}`}>Beta program</h4>
                            <div className="text-base-darkest lg:text-base text-sm">
                    ...
                    <div className="border-x-1px border-bottom-1px border-accent-cool desktop:border-0 desktop:grid-col-6">
                        <div className='padding-x-205 desktop:padding-x-4 padding-y-5 bg-primary-lighter radius-md'>
                            ...
                            <h4 className={`text-center text-accent-cool-darker ${styles.partnerItemHeaders} margin-top-205 desktop:margin-top-0 margin-bottom-105`}>Focus groups</h4>
                            <div className="text-base-darkest lg:text-base text-sm">
            ...
            <div className='grid-container padding-x-205'>
                <div className="grid-row padding-y-5 desktop:padding-y-9 desktop:padding-top-5 desktop:padding-bottom-0">
                    ...
                    <div className='desktop:grid-col-7 desktop:padding-left-7'>
                        ...
                        <div className="margin-bottom-2 text-base-darkest font-normal font-sm lg:text-base text-sm">
